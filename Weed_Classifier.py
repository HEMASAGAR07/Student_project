...
img = mpimg.imread('/content/Student Project/Celosa/00ab26d4-71a6-4185-970f-e03166ad10ae.jpeg')
imgplt = plt.imshow(img)
plt.show()
# display Crowfoot image
img = mpimg.imread('/content/Student Project/Crowfoot grass/03e0ed29-50c9-4872-b174-8d8287b33cfa.jpeg')
imgplt = plt.imshow(img)
plt.show()
# display chloris image
img = mpimg.imread('/content/Student Project/Purple Chloris/02d106b4-7015-45d4-b1a0-d269bde487d2.jpeg')
imgplt = plt.imshow(img)
plt.show()
file_names = os.listdir('/content/train/')
